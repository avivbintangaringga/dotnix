...
{
  den.aspects.scripts.provides.nv-switch = { user }: {
    nixos = { pkgs, ... }: {
      environment.systemPackages = with pkgs; [
        ...
        (writeShellScriptBin "nv-switch" ''
          ...
          switch_to_vm() {
            ...
            # sudo systemctl --user --machine=${user.userName}@ stop swaync # TEMPORARY FIX
            ...
            # sudo systemctl --user --machine=${user.userName}@ start swaync # TEMPORARY FIX
